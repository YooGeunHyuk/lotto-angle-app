...
const s = StyleSheet.create({
  ...
  sortControl: { flexDirection: 'row', borderWidth: 1, borderColor: C.border, borderRadius: 999, overflow: 'hidden', backgroundColor: C.card },
  sortBtn: { paddingHorizontal: 8, paddingVertical: 4 },
  sortBtnActive: { backgroundColor: C.black },
  sortText: { fontSize: 9.5, fontWeight: '800', color: C.gray },
