...
const s = StyleSheet.create({
  ...
  listHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginHorizontal: 16, marginTop: 14, marginBottom: 2 },
  titleLine: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 },
  sectionTitle: { fontSize: 13, fontWeight: '800', color: C.black },
  dim: { fontSize: 10, color: C.gray },
  areaInline: { flexShrink: 1, fontSize: 10, color: C.gray },
  sortControl: { height: 18, flexDirection: 'row', borderWidth: 1, borderColor: C.border, borderRadius: 999, overflow: 'hidden', backgroundColor: C.card },
  sortBtn: { minHeight: 16, paddingHorizontal: 8, paddingVertical: 0, alignItems: 'center', justifyContent: 'center' },
  sortBtnActive: { backgroundColor: C.black },
  sortText: { fontSize: 9, lineHeight: 12, fontWeight: '800', color: C.gray },
